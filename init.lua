...
-- Oil keymaps
vim.keymap.set('n', '-', '<CMD>Oil<CR>', { desc = 'Go to Oil-based parent directory of file buffer' })

vim.keymap.set('n', '<leader>q', vim.diagnostic.setloclist, { desc = 'Open diagnostic [Q]uickfix list' })

-- Nvim-Tree keymaps
vim.keymap.set('n', '<leader>n', ':NvimTreeToggle<CR>', { desc = 'Toggle [N]vim-Tree view on and off', noremap = true, silent = true })
...
vim.keymap.set('n', '<leader>-', '80i-<Esc>o', { desc = 'Draw a single divider line'})
vim.keymap.set('n', '<leader>=', '80i=<Esc>o', { desc = 'Draw a double divider line'})
...
require('lazy').setup({
  ...
  { -- Highlight, edit, and navigate code
    ...
    build = ':TSUpdate',
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'vim', 'vimdoc', "javascript", "typescript", "tsx", "json" },
